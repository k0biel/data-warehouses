CREATE TABLE DimMaterial (
    MaterialKey INTEGER IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE DimSupplier (
    SupplierKey INTEGER IDENTITY(1,1) PRIMARY KEY,
    SupplierName VARCHAR(128)
);

CREATE TABLE DimWarehouse (
    WarehouseKey INTEGER IDENTITY(1,1) PRIMARY KEY,
    WarehouseName VARCHAR(40),
    Location VARCHAR(40)
);

CREATE TABLE DimProject (
    ProjectKey INTEGER IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE FactMaterialOrders (
    ...
    CONSTRAINT PK_FactMaterialOrders PRIMARY KEY (
        MaterialKey, SupplierKey, WarehouseKey, OrderDateKey
    )
);
